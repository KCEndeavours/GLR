	...
	return e("ScreenGui", {
		...
		Root = e("Frame", {
			...
			Constraint = e("UISizeConstraint", {
				MaxSize = Vector2.new(1020, 104),
				MinSize = Vector2.new(560, 92),
			}),
			Backdrop = e("Frame", {
			...
			StartLabel = e("TextLabel", {
				BackgroundTransparency = 1,
				Font = Enum.Font.GothamBold,
				Position = UDim2.fromOffset(0, 2),
				Size = UDim2.fromOffset(110, 18),
				Text = props.startLabel or "START",
				TextColor3 = Color3.fromRGB(187, 233, 255),
				TextSize = 12,
				TextXAlignment = Enum.TextXAlignment.Left,
				ZIndex = 7,
			}),
			EndLabel = e("TextLabel", {
				AnchorPoint = Vector2.new(1, 0),
				BackgroundTransparency = 1,
				Font = Enum.Font.GothamBold,
				Position = UDim2.fromScale(1, 0.02),
				Size = UDim2.fromOffset(110, 18),
				Text = props.endLabel or "END",
				TextColor3 = Color3.fromRGB(255, 214, 174),
				TextSize = 12,
